...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in paiement_service_pb2_grpc.py depends on'
...
class PaiementServiceStub(object):
...
class PaiementServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
