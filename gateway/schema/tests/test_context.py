...
def _info(connection_params: dict, header: str = "") -> MagicMock:
...
class ConnectionParamsAuthTests(TestCase):
    ...
    def test_require_auth_lit_le_token_des_connection_params(self, mock_auth_client):
    ...
    def test_token_from_connection_params_tolerant_aux_cles(self):
    ...
    def test_require_auth_sans_token_leve_autherror(self):
