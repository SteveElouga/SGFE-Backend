"""Tests de la migration `0015_audit_log_role_runtime` (voir AUDIT_SGFE.md
§8·J et `paiements/db_hardening.py`).
...
_migration = importlib.import_module("paiements.migrations.0015_audit_log_role_runtime")
...
class MigrationOperationsTests(SimpleTestCase):
    ...
    def test_depend_de_la_derniere_migration(self) -> None:
        self.assertIn(("paiements", "0014_sessionpaiementenligne"), _migration.Migration.dependencies)
