...
if not TESTING:
    ...
    _LOGGING_HANDLER_CONFIG["file"] = {
        ...
        # Chaînage de hash tamper-evident (voir notifications/log_integrity.py,
...
LOGGING: dict[str, object] = {
    ...
    "filters": {
        "trace_context": {"()": "notifications.logging_utils.TraceContextFilter"},
    },
    "formatters": {
        "iso8601_chained": {
        ...
        # trace_id/span_id : voir notifications/logging_utils.py::TraceContextFilter.
        "json": {
