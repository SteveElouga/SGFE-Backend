"""Tests de la migration `0011_audit_log_role_runtime` (voir AUDIT_SGFE.md
§8·J et `notifications/db_hardening.py`).
...
_migration = importlib.import_module("notifications.migrations.0011_audit_log_role_runtime")
...
class MigrationOperationsTests(SimpleTestCase):
    ...
    def test_depend_de_la_derniere_migration(self) -> None:
        self.assertIn(("notifications", "0010_audit_log_immutable"), _migration.Migration.dependencies)
