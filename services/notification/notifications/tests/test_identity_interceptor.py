...
from notifications.grpc_interceptors import CallerIdentity, IdentityInterceptor, get_caller
...
class IdentityInterceptorTests(SimpleTestCase):
    def _wrap(self, metadata: tuple[tuple[str, str], ...]) -> Any:
        ...
        details = MagicMock(method="/Notifications/X", invocation_metadata=metadata)
