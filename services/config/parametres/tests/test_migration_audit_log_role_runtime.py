"""Tests de la migration `0005_audit_log_role_runtime` (voir AUDIT_SGFE.md
§8·J et `parametres/db_hardening.py`).
...
_migration = importlib.import_module("parametres.migrations.0005_audit_log_role_runtime")
...
class MigrationOperationsTests(SimpleTestCase):
    ...
    def test_depend_de_la_derniere_migration(self) -> None:
        self.assertIn(("parametres", "0004_audit_log_immutable"), _migration.Migration.dependencies)
