...
from parametres.grpc_interceptors import CallerIdentity, IdentityInterceptor, get_caller
...
class IdentityInterceptorTests(SimpleTestCase):
    def _wrap(self, metadata: tuple[tuple[str, str], ...]) -> Any:
        ...
        details = MagicMock(method="/Parametres/X", invocation_metadata=metadata)
