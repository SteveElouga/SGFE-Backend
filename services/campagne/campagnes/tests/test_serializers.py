...
class ReleveToProtoTests(SimpleTestCase):
    def test_date_releve_datetime_est_convertie_en_iso(self) -> None:
        import datetime
    ...
    def test_date_releve_str_brute_nest_pas_cassee(self) -> None:
    ...
    def test_date_releve_absente_retourne_chaine_vide(self) -> None:
        campagne = Campagne(nom="C", periode_mois=7, periode_annee=2026, statut=StatutCampagne.EN_COURS)
        releve = Releve(
            campagne=campagne,
            abonne_id="abonne-1",
...
class CampagneToProtoTests(SimpleTestCase):
    def test_campagne_to_proto_serialise_created_by(self) -> None:
    ...
    def test_campagne_to_proto_created_by_absent_donne_chaine_vide(self) -> None:
