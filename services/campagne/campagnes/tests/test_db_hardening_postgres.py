...
`campagnes/db_hardening.py` pour le constat empirique complet : le rôle de
...
Gaté par `FORCE_POSTGRES_TESTS` (comme le job CI `test-campagne`, qui fait
...
from campagnes.db_hardening import role_runtime
from campagnes.models import AuditLog
