...
§8·J et `campagnes/db_hardening.py`).
...
_migration = importlib.import_module("campagnes.migrations.0011_audit_log_role_runtime")
...
class MigrationOperationsTests(SimpleTestCase):
    ...
    def test_depend_de_la_derniere_migration(self) -> None:
        self.assertIn(("campagnes", "0010_audit_log_immutable"), _migration.Migration.dependencies)
