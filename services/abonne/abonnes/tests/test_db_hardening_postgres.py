...
`abonnes/db_hardening.py` pour le constat empirique complet : le rôle de
...
Gaté par `FORCE_POSTGRES_TESTS` (comme le job CI `test-abonne`, qui fait
...
from abonnes.db_hardening import role_runtime
