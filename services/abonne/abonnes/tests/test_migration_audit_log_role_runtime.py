...
§8·J et `abonnes/db_hardening.py`).
...
_migration = importlib.import_module("abonnes.migrations.0011_audit_log_role_runtime")
...
class MigrationOperationsTests(SimpleTestCase):
    ...
    def test_depend_de_la_derniere_migration(self) -> None:
        self.assertIn(("abonnes", "0010_audit_log_immutable"), _migration.Migration.dependencies)
