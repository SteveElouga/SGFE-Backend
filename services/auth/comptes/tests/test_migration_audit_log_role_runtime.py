...
§8·J et `comptes/db_hardening.py`).
...
_migration = importlib.import_module("comptes.migrations.0010_audit_log_role_runtime")
...
class MigrationOperationsTests(SimpleTestCase):
    ...
    def test_depend_de_la_derniere_migration(self) -> None:
        self.assertIn(("comptes", "0009_user_date_desactivation"), _migration.Migration.dependencies)
