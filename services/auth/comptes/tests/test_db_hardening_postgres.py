...
`comptes/db_hardening.py` pour le constat empirique complet : le rôle de
...
Gaté par `FORCE_POSTGRES_TESTS` (comme le job CI `test-auth`, qui fait
...
propriétaire tout du long (migrations 0001-0010 appliquées avec les pleins
...
from comptes.db_hardening import role_runtime
