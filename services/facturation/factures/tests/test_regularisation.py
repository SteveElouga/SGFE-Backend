...
class CreerRegularisationTest(TestCase):
    ...
    def test_cree_une_facture_de_serie_reg(self):
    ...
    def test_sans_releve_ni_campagne(self):
    ...
    def test_exigible_immediatement_par_defaut(self):
    ...
    def test_echeance_explicite_respectee(self):
    ...
    def test_abonne_manquant_refuse(self):
        with self.assertRaises(ValidationError):
            self.svc.creer_regularisation(abonne_id="", montant=1_000, motif="X")

    def test_motif_est_deponctue_des_espaces(self):
        f = self.svc.creer_regularisation(abonne_id="ab-1", montant=1_000, motif="  Reliquat  ")
        self.assertEqual(f.motif, "Reliquat")

    def test_un_solde_est_initialise(self):
    ...
    def test_deux_regularisations_ne_se_marchent_pas_dessus(self):
    ...
    def test_elle_est_impayee_a_la_naissance(self):
        f = self.svc.creer_regularisation(abonne_id="ab-1", montant=1_000, motif="Reliquat")
...
class NatureDansLeProtoTest(TestCase):
    ...
    def test_regularisation_transporte_sa_nature_et_son_motif(self):
        f = self.svc.creer_regularisation(
            abonne_id="ab-1", montant=50_000, motif="Arriéré antérieur à la mise en service"
        )
    ...
    def test_une_consommation_se_declare_aussi(self):
